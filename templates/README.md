...
Lab files students can download and use directly.

| File | What it is | Used in |
|---|---|---|
| [labTemplate.pptx](labTemplate.pptx) | Heritage 3D Lab PowerPoint slide template — title, content, and thank-you slides with correct colors and footer | [Giving a Presentation](../giving-a-presentation.md) |
