...
All lab presentations use the Heritage 3D Lab slide template. [Download labTemplate.pptx](templates/labTemplate.pptx) from this repo. If you are not using it, please switch before you share your slides with anyone.
...
- [ ] Using the [Heritage 3D Lab slide template](templates/labTemplate.pptx)?
...
- How does this change what practitioners should do?
- Where would this break down?
- What would you do differently if you started over?

Prepare honest, considered answers. You do not need to defend every decision as perfect — you need to show that you understood the tradeoffs.

---

## Further Reading

- [Making Figures](making-figures.md) — the figures in your talk are the same ones in your paper; make them well
- [PhD Milestones](phd-milestones.md) — context on committee meetings, comprehensive exam, and defense logistics
